   ...
   <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="{{route('product.index')}}"><i data-feather="box"></i> <span>Voyages</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('product.index')}}"><i class="fa fa-circle"></i>Liste Voyages</a></li>
                            <li><a href="{{route('product.create')}}"><i class="fa fa-circle"></i>Ajouter</a></li>
                         
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="{{route('product.index')}}"><i data-feather="box"></i> <span>Trajets</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('product.index')}}"><i class="fa fa-circle"></i>Liste Trajets</a></li>
                            <li><a href="{{route('product.create')}}"><i class="fa fa-circle"></i>Ajouter</a></li>
                         
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="{{route('brand.index')}}"><i data-feather="droplet"></i><span>Réservations</span></a>
                    <li>
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="#"><i class="fa fa-circle"></i>Marques</a></li>
                            <li><a href="#"><i class="fa fa-circle"></i>Modèles</a></li>
                        </ul>
